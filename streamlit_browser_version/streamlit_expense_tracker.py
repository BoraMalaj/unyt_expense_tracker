...
if page == "Home ":
    ...
    if manager.expenses_df.empty:
        ...
        with st.form("edit_form"):
            ...
            # predefined categories (see also comment on line 445 by "add new expense")
    ...
    with st.form("add_budget"):
        ...
        category = st.selectbox("Category (blank for overall)", options=["overall"] + PREDEFINED_CATEGORIES)    # just like lines 445 and 465
        amount = st.number_input("Amount", min_value=0.01)
